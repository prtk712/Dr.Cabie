  ...
  Cropper.prototype = {
    ...
    init: function () {
      ...
      $clone.one("load", function () {
        ...
        globalwidth =image.naturalWidth;
        globalheight=image.naturalHeight;
        _this.active = true;
        _this.src = src;
        _this.image = image;
        _this.build();
    ...
    initCropper: function () {
      ...
      if (((image.naturalWidth * container.height / image.naturalHeight) - container.width) >= 0) {
        cropper = {
          height: screen.height-$('footer').height(),
          width: screen.width,
          left: 0
        };

        cropper.top = 0//(container.height - cropper.height) / 2;
      } else {
        cropper = {
          height: screen.height-$('footer').height(),
          width: screen.width,
        ...
        cropper.left = 0 //(container.width - cropper.width) / 2;
      }
   ...
   data.width=globalwidth-100;
   data.height=round(globalheight/3)
